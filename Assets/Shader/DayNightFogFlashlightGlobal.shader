Shader "Custom/DayNightFogFlashlightGlobal"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Flashlight params (per material OR set as globals)
            float4 _FlashColor;
            ...
            float3 _FlashPos;   // world-space pos
            float3 _FlashDir;   // world-space dir (normalized)
